...
### Looking for **React + TypeScript** version of this? 
#### Check my other repository for a detailed article: [GitHub - image-crop-uploader-ts](https://github.com/sukanta47/image-crop-uploader-ts) 
